...
load('~/data/scEiaD//HS_traj_sling__clus8__subdivideFALSE.Rdata') #sling and diffPT in one
...
for (i in paste0('slingPseudotime_', select_curves)){
  try({draw(hm_maker(i, 15, onlyShowTF = TRUE, round_to = 0.1, column_title = i,  max_val = 5) )})
}
```
...
```{r, fig.width = 3}
gene <- 'NEUROD4'
lmX <- lm_maker(make_tidy_time('slingPseudotime_6', c('ENSG00000123307','ENSG00000074800')))
