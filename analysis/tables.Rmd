...
# load('seurat_obj/Mus_musculus_Macaca_fascicularis_Homo_sapiens__standard__full__batch.seuratV3.Rdata')
# stats <- seurat__standard@meta.data %>%
#   as_tibble(rownames = 'value') %>%
#   left_join(cell_info_labels %>% select(-batch, -study_accession, -Age), by = 'value')
# save(stats, file = 'post_filtering_stats.Rdata')
load('/Volumes/data/projects/nei/mcgaughey/massive_integrated_eye_scRNA/post_filtering_stats_2019_11_06.Rdata')
