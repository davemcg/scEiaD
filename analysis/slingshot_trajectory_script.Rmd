...
output:
  html_document:
    code_folding: hide
params:
    data: "~/data/scEiaD/sling_traj_HS_celltype_earlyRPC_start.Rdata"
---
...
node_pos <- umap_cut %>%
  ...
  dplyr::rename(name = CellType_predict)
