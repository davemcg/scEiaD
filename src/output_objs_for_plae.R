...
library(pool)
library(RSQLite)
pool <- dbPool(drv = SQLite(), dbname = "site/scEiaD__2020_08_13__Mus_musculus_Macaca_fascicularis_Homo_sapiens-5000-counts-TabulaDroplet-batch-scVI-8-0.1-15-7.sqlite", idleTimeout = 3600000)
