...
hs_msg_gene_ids <- hs_gtf %>% 
  ...
  mutate(mouse_gene_id = NA, macaque_gene_id= NA)
mm_msg_gene_ids <-  mm_gtf %>% 
  ...
  mutate(human_gene_id = NA, macaque_gene_id= NA, gene_name=toupper(gene_name))
mf_msg_gene_ids <-  mf_gtf %>%
  ...
  mutate(human_gene_id = NA, mouse_gene_id= NA, gene_name=toupper(gene_name))
